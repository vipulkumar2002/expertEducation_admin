  ...
  render() {
    return (
      <div>
        <Card>
          <CardHeader>
            <CardTitle>SMS Channels </CardTitle>
          </CardHeader>
          <CardBody>
            <Form className="m-1">
              {/* <Row> */}
                ...
                <Col lg="6" md="6" sm="6" className="mb-2">
                  <Label>Please select sms channel :</Label>
                ...
                <Col lg="6" md="6" sm="6" className="mb-2">
                  <Label>MIM SMS API Key : </Label>
                  <Input type="text" placeholder="Company Name" />
                </Col>
                <Col lg="6" md="6" sm="6" className="mb-2">
                  <Label>MIM SMS SENDER ID : </Label>
                  <Input type="text" placeholder="Name" />
                </Col>
                <Col lg="6" md="6" sm="6" className="mb-2">
                <FormGroup>
                <Label>Enable OTP Confirmation on Login / Register:</Label>
                  <div>
                    <CustomInput 
                    type="switch" 
                    id="exampleCustomSwitch" 
