...
class ViewCompletedPayments extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      data: {},
              ...
              <Row className="m-2">
                ...
                <Col>
                  <Button
                    ...
                    onClick={() => history.push("/app/sellerPayout/pendingPayments/completedPaymentsList")}
                  >
                    Back
                  </Button>
                </Col>
...
export default ViewCompletedPayments;
